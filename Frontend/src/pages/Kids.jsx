          ...
          <div className="hero-content">
            <div className="hero-kicker-wrapper">
              <span className="hero-kicker-badge">
                ...
                KIDS' EDIT · PLAYFUL ESSENTIALS
              </span>
            </div>
            <h1 className="hero-title">
              Built For Play, <br />
              <span className="hero-title-highlight">Made To Last.</span>
            </h1>
            <p className="hero-subtitle">
              Super-soft 100% organic cotton, cheerful artwork, and all-day comfort.
            </p>
            <div className="hero-cta-group">
              <a href="#kids-catalog" className="btn btn-hero-primary btn-lg">
                Shop the Collection
