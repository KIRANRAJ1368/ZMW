...
export default function ProductDetail() {
  ...
  return (
    <div className="product-detail-page">
      ...
      {/* ── PRODUCT INSIGHTS Section (4 Cards in ZMW Aesthetic) ────── */}
      <section className="section-padding pd-insights-section">
        <div className="container">
          <div className="section-header">
            <span className="section-eyebrow">CRAFTSMANSHIP & FIT</span>
            <h2 className="section-title">Product Insights</h2>
            <p className="section-subtitle">
              Engineered from yarn to garment wash for effortless drape, enduring structure, and shape retention.
            </p>
          </div>
          ...
          <div className="pd-insights-grid">
            <div className="pd-insight-card">
              <img
                ...
                loading="lazy"
              />
              <div className="pd-insight-scrim">
                <span className="pd-insight-badge-pill">DENSITY</span>
                <h4 className="pd-insight-title">240 GSM Heavyweight Fabric</h4>
                <p className="pd-insight-text">Substantial drape that holds shape across wears with zero opacity breakdown.</p>
              </div>
            </div>
            ...
            <div className="pd-insight-card">
              ...
              />
              <div className="pd-insight-scrim">
                <span className="pd-insight-badge-pill">SILHOUETTE</span>
                <h4 className="pd-insight-title">Engineered Boxy Fit</h4>
                <p className="pd-insight-text">Intentionally wider chest and dropped shoulders for relaxed modern streetwear drape.</p>
              </div>
            </div>
            ...
            <div className="pd-insight-card">
              ...
              />
              <div className="pd-insight-scrim">
                <span className="pd-insight-badge-pill">GRAPHICS</span>
                <h4 className="pd-insight-title">Fade-Proof Screen Prints</h4>
                <p className="pd-insight-text">Heat-cured high-density inks that resist cracking, peeling, or fading over time.</p>
              </div>
            </div>
            ...
            <div className="pd-insight-card">
              ...
              />
              <div className="pd-insight-scrim">
                <span className="pd-insight-badge-pill">COMFORT</span>
                <h4 className="pd-insight-title">100% Combed Cotton</h4>
                <p className="pd-insight-text">Long-staple fibers combed for superior softness, breathability, and natural hand-feel.</p>
              </div>
            </div>
          </div>
        </div>
